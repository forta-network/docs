...
If you are new to Forta, a starter kit will help you get started on monitoring and protecting Web3 projects and assets right away with little to no technical/security experience.
...
// WIP - update instructions once UI is updated.
...
Non-technical users can configure and create their own detection bots without touching any code via the bot wizard.
