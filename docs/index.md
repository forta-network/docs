...
A prerequisite for publishing is that you are authorized to do so in the Agent Registry contract, which is currently deployed on the Göerli testnet. Once you are approved to publish, you will need to send a “publish” transaction to the Agent Registry (using the CLI `publish` command). To do this you will need Göerli ETH (you can get some at [https://faucet.goerli.mudit.blog](https://faucet.goerli.mudit.blog)).
...
Once published, you can view the findings generated by your agent using this dapp: [https://forta.netlify.app/](https://forta.netlify.app/)
