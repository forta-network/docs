...
Once your agent is published and added to a pool, you can view the findings it generates using this dapp: [https://forta.netlify.app/](https://forta.netlify.app/)
